...
public class CampaignMaker implements IFormServerEventHandler {
	...
	public String executeServerEvent(IFormReference ifr, String control, String event, String value) {
		...
		case "Change": {
			...
			case "onChangeGridModelYear": {
				NGLog.consoleLog("Inside onChangeModelYear");
				return objCommon.onChangeGridModelYear(ifr, value);
			}
			case "onChangeGridModel": {
				NGLog.consoleLog("Inside onChangeModel");
				return objCommon.onChangeGridModel(ifr, value);
			}
			case "generateCampCode": {
				NGLog.consoleLog("Inside generateCampCode");
				return objCommon.generateCampCode(ifr);
			}
			...
			case "onChangeRetailPrice": {
				NGLog.consoleLog("Inside onChangeRetailPrice");
				return objCommon.onChangeRetailPrice(ifr);
			}
			}
		}
		case "Click": {
			...
			/*
			 * case "getExcelData": { NGLog.consoleLog("Inside getExcelData"); return
			 * objCommon.getExcelData(ifr); }
			 */
			case "getExcelData": {
			...
			case "onClickAddGrid": {
				NGLog.consoleLog("Inside onClickAddGrid in Main Class");
				return objCommon.onClickAddGrid(ifr);
			}
			}
		}
		}
