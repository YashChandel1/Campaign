...
function docPreHook(docTypeName, FileExt) {
	console.log("Inside docPreHook ");
	if (docTypeName.includes('Poster') && FileExt != 'png') {
		return "F~The allowed file type for " + docTypeName + " is .png.";
	} else if (docTypeName.includes('Excel') && FileExt != 'xlsx' && FileExt != 'xls') {
		return "The allowed file types for " + docTypeName + " are .xlsx and .xls.";
	}
	return "S~Success";
}